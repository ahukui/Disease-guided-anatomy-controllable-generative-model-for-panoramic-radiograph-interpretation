    ...
    def __call__(
        ...
        **kwargs,
        ...
        if not output_type == "latent":
            image = self.vae.decode(latents / self.vae.config.scaling_factor, return_dict=False)[0] #generator=generator
        else:
            image = latents
        ...
        return image #StableDiffusionPipelineOutput(images=image, nsfw_content_detected=None)